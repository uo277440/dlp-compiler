...
public class ExecuteCGVisitor extends AbstractVisitor<Type, FunctionDefinition> {
    ...
    public VoidType visit(Write i, FunctionDefinition param) {
        ...
        execute[input-> expression]
                ...
                store{ex.type}
         */
            i.getBody().accept(addressV, null);
            cg.in(i.getBody().getType());
            cg.store(i.getBody().getType());
        return null;
    }
    @Override
    public VoidType visit(Read r, FunctionDefinition param) {
        ...
        execute[input-> expression]
                ...
                store{ex.type}
         */
        r.getToRead().accept(this,param);
        cg.out(r.getToRead().getType());
        return null;
    }
    @Override
    ...
    public VoidType visit(Return r, FunctionDefinition param) {
        ...
        cg.ret(r.getExpression().getType().getNumberOfBytes(),-
                        param.getLocalsSize(),
